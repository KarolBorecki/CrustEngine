...
int main(int argc, char *argv[])
{
    ...
    Mesh mesh("Sample mesh");
    MeshLoader::LoadMeshFromFile("/Users/karolborecki/Desktop/CrustEngine/CrustEngine/Tmp/meshes/teapot.obj", &mesh);
    RenderObject object(mesh);
    scene.AddObject(object);
    
    Mover mover(12, 12, 12);
    object.AttachScript(mover);
