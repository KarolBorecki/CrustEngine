...
\label{_s_d_l__quit_8h_source}\index{/Users/karolborecki/Desktop/CrustEngine/CrustEngine/Externals/SDL/include/SDL2/SDL\_quit.h@{/Users/karolborecki/Desktop/CrustEngine/CrustEngine/Externals/SDL/include/SDL2/SDL\_quit.h}}
...
\DoxyCodeLine{21 }
\DoxyCodeLine{28 \textcolor{preprocessor}{\#ifndef SDL\_quit\_h\_}}
\DoxyCodeLine{29 \textcolor{preprocessor}{\#define SDL\_quit\_h\_}}
\DoxyCodeLine{30 }
...
\DoxyCodeLine{33 }
\DoxyCodeLine{53 \textcolor{comment}{/* There are no functions directly affecting the quit event */}}
\DoxyCodeLine{54 }
\DoxyCodeLine{55 \textcolor{preprocessor}{\#define SDL\_QuitRequested() \(\backslash\)}}
\DoxyCodeLine{56 \textcolor{preprocessor}{        (SDL\_PumpEvents(), (SDL\_PeepEvents(NULL,0,SDL\_PEEKEVENT,SDL\_QUIT,SDL\_QUIT) > 0))}}
\DoxyCodeLine{57 }
\DoxyCodeLine{58 \textcolor{preprocessor}{\#endif }\textcolor{comment}{/* SDL\_quit\_h\_ */}\textcolor{preprocessor}{}}
