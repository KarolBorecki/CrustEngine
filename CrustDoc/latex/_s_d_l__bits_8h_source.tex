...
\label{_s_d_l__bits_8h_source}\index{/Users/karolborecki/Desktop/CrustEngine/CrustEngine/Externals/SDL/include/SDL2/SDL\_bits.h@{/Users/karolborecki/Desktop/CrustEngine/CrustEngine/Externals/SDL/include/SDL2/SDL\_bits.h}}
...
\DoxyCodeLine{51 \textcolor{keyword}{extern} \_\_inline \textcolor{keywordtype}{int} \_SDL\_bsr\_watcom(\mbox{\hyperlink{_s_d_l__stdinc_8h_add440eff171ea5f55cb00c4a9ab8672d}{Uint32}});}
...
\DoxyCodeLine{58 }
\DoxyCodeLine{59 \mbox{\hyperlink{begin__code_8h_addf1f12c70f89102cc187297860c5961}{SDL\_FORCE\_INLINE}} \textcolor{keywordtype}{int}}
\DoxyCodeLine{60 \mbox{\hyperlink{_s_d_l__bits_8h_ada8cd16089cc635936dfe1a6884729a4}{SDL\_MostSignificantBitIndex32}}(\mbox{\hyperlink{_s_d_l__stdinc_8h_add440eff171ea5f55cb00c4a9ab8672d}{Uint32}} \mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}})}
\DoxyCodeLine{61 \{}
...
\DoxyCodeLine{66     \textcolor{keywordflow}{if} (\mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}} == 0) \{}
\DoxyCodeLine{67         \textcolor{keywordflow}{return} -\/1;}
\DoxyCodeLine{68     \}}
\DoxyCodeLine{69     \textcolor{keywordflow}{return} 31 -\/ \_\_builtin\_clz(\mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}});}
\DoxyCodeLine{70 \textcolor{preprocessor}{\#elif defined(\_\_WATCOMC\_\_) \&\& defined(\_\_386\_\_)}}
\DoxyCodeLine{71     \textcolor{keywordflow}{if} (\mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}} == 0) \{}
\DoxyCodeLine{72         \textcolor{keywordflow}{return} -\/1;}
\DoxyCodeLine{73     \}}
\DoxyCodeLine{74     \textcolor{keywordflow}{return} \_SDL\_bsr\_watcom(\mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}});}
\DoxyCodeLine{75 \textcolor{preprocessor}{\#elif defined(\_MSC\_VER)}}
\DoxyCodeLine{76     \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} \mbox{\hyperlink{_s_d_l__opengl__glext_8h_a57f14e05b1900f16a2da82ade47d0c6d}{index}};}
\DoxyCodeLine{77     \textcolor{keywordflow}{if} (\_BitScanReverse(\&\mbox{\hyperlink{_s_d_l__opengl__glext_8h_a57f14e05b1900f16a2da82ade47d0c6d}{index}}, \mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}})) \{}
\DoxyCodeLine{78         \textcolor{keywordflow}{return} \mbox{\hyperlink{_s_d_l__opengl__glext_8h_a57f14e05b1900f16a2da82ade47d0c6d}{index}};}
\DoxyCodeLine{79     \}}
...
\DoxyCodeLine{86     \textcolor{keyword}{const} \mbox{\hyperlink{_s_d_l__stdinc_8h_add440eff171ea5f55cb00c4a9ab8672d}{Uint32}} \mbox{\hyperlink{_s_d_l__opengl__glext_8h_a0f71581a41fd2264c8944126dabbd010}{b}}[] = \{0x2, 0xC, 0xF0, 0xFF00, 0xFFFF0000\};}
...
\DoxyCodeLine{91 }
\DoxyCodeLine{92     \textcolor{keywordflow}{if} (\mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}} == 0) \{}
\DoxyCodeLine{93         \textcolor{keywordflow}{return} -\/1;}
\DoxyCodeLine{94     \}}
\DoxyCodeLine{95 }
\DoxyCodeLine{96     \textcolor{keywordflow}{for} (i = 4; i >= 0; i-\/-\/)}
\DoxyCodeLine{97     \{}
\DoxyCodeLine{98         \textcolor{keywordflow}{if} (\mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}} \& \mbox{\hyperlink{_s_d_l__opengl__glext_8h_a0f71581a41fd2264c8944126dabbd010}{b}}[i])}
\DoxyCodeLine{99         \{}
\DoxyCodeLine{100             \mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}} >>= S[i];}
...
\DoxyCodeLine{107 \}}
\DoxyCodeLine{108 }
\DoxyCodeLine{109 \mbox{\hyperlink{begin__code_8h_addf1f12c70f89102cc187297860c5961}{SDL\_FORCE\_INLINE}} \mbox{\hyperlink{_s_d_l__stdinc_8h_a8fca68df0f976765230fe589a7c7733b}{SDL\_bool}}}
\DoxyCodeLine{110 \mbox{\hyperlink{_s_d_l__bits_8h_a9ca9ab50814f9cfbce5c1cba379b001d}{SDL\_HasExactlyOneBitSet32}}(\mbox{\hyperlink{_s_d_l__stdinc_8h_add440eff171ea5f55cb00c4a9ab8672d}{Uint32}} \mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}})}
\DoxyCodeLine{111 \{}
\DoxyCodeLine{112     \textcolor{keywordflow}{if} (\mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}} \&\& !(\mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}} \& (\mbox{\hyperlink{_s_d_l__opengl_8h_ad0e63d0edcdbd3d79554076bf309fd47}{x}} -\/ 1))) \{}
\DoxyCodeLine{113         \textcolor{keywordflow}{return} \mbox{\hyperlink{_s_d_l__stdinc_8h_a8fca68df0f976765230fe589a7c7733ba32efa84cfb0a91b0eee1edf6e941cf74}{SDL\_TRUE}};}
\DoxyCodeLine{114     \}}
\DoxyCodeLine{115     \textcolor{keywordflow}{return} \mbox{\hyperlink{_s_d_l__stdinc_8h_a8fca68df0f976765230fe589a7c7733ba76e680af86c5508ea4ccd9f969eb1ea2}{SDL\_FALSE}};}
\DoxyCodeLine{116 \}}
\DoxyCodeLine{117 }
